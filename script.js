...
function addToCart(event) {
    ...
    const price = parseFloat(menuItem.querySelector('.price').price);
...
// التعديل هنا لضمان استخدام المسار الصحيح للمجلد الفرعي /Dirty55/
if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => {
        // *** هذا هو السطر الذي تم تعديله ليناسب مسار GitHub Pages: ***
