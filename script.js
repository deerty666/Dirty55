...
const menuData = [
  ...
  { 
    ...
    items:[
      // الوجبة 1
      {id:"sh1", img:"/Dirty55/sh01.webp", name:"شواية", basePrice:46, availableIn: ['branch1', 'branch3'], options:[ 
    ...
    // الوجبة 2
    {id:"sh2", img:"/Dirty55/sh02.webp", name:"نص شواية", basePrice:24, availableIn: ['branch1', 'branch2', 'branch3'], options:[
      {name:"رز شعبي", price:0},
  ...
  { 
    ...
    items:[
      // الوجبة 1
      {id:"mn1", img:"/Dirty55/mn01.webp", name:"مندي", basePrice:46, availableIn: ['branch2', 'branch3'], options:[ 
      {name:"رز شعبي", price:0},
      {name:"رز بشاور", price:4},
      {name:"رز مندي", price:4},
      {name:"رز مثلوثه", price:4}
  ...
  { 
    ...
    items:[
    // الوجبة 1
    {id:"t1", img:"/Dirty55/me01.webp", name:"تيس مندي كامل", basePrice:1550, isAvailable: false, availableIn: ['branch1', 'branch3'], options:[ 
      {name:"رز شعبي", price:0},
  ...
  { 
    ...
    items:[
    // الوجبة الجديدة: شوربة (تم وضعها في البداية)
  ...
  { 
    ...
    items:[
    // الوجبة الجديدة: ورق عنب (تم وضعها في البداية)
