...
// ====== 2. دالة الإضافة إلى السلة (تُستدعى من زر الـ 'أضف') ======
function addToCart(itemId, itemName, itemPrice) {
    ...
    // رسالة التنبيه التي لم تظهر سابقاً
    alert(`تم إضافة ${itemName} إلى السلة!`); 
    updateCartUI(); // تحديث واجهة السلة
}

// دالة لتحديث الواجهة البصرية للسلة في HTML
...
// ====== 3. دالة إنشاء رابط الواتساب النهائي (على نقرة الزر) ======
...
// ====== 4. كود الرسالة المنبثقة للتثبيت (PWA) ======
let deferredPrompt; 
...
window.addEventListener('beforeinstallprompt', (e) => {
    ...
    if (installButton) {
        // هذا الكود يجعل زر "تثبيت المنيو" يظهر
