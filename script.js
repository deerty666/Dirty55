...
const menuData = [
  ...
  { 
    ...
    items:[
      {id:"mg1", img:"/Dirty55/mg.jpg", name:"دجاج مضغوط حبه", basePrice:50, options:[{name:"رز شعبي", price:0}]},
  ...
  { 
    ...
    items:[
    {id:"t1", img:"/Dirty55/t.jpg", name:"تيس مندي كامل", basePrice:1550, options:[
      {name:"رز شعبي", price:0},
