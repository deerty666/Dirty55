...
const menuData = [
  ...
  { 
    ...
    items:[
      // الوجبة 1
      {id:"mdf1", img:"/Dirty55/mf00.webp", name:"مدفون حبه كامل", basePrice:46, availableIn: ['branch1', 'branch2', 'branch3'], options:[
      {name:"رز شعبي", price:0},
      {name:"رز بشاور", price:4},
      {name:"رز مندي", price:4},
      {name:"رز مثلوثه", price:4}
  ...
  { 
    ...
    items:[
    // الوجبة 1
    {id:"t1", img:"/Dirty55/me00.webp", name:"تيس مندي كامل", basePrice:1550, isAvailable: false, availableIn: ['branch1', 'branch2', 'branch3'], options:[ 
      {name:"رز شعبي", price:0},
      {name:"رز بشاور", price:50},
      {name:"رز مندي", price:50}
    ]},
    // الوجبة 2
    {id:"t2", img:"/Dirty55/me00.webp", name:"نص تيس مندي", basePrice:750, availableIn: ['branch1', 'branch2', 'branch3'], options:[
      {name:"رز شعبي", price:0},
      {name:"رز بشاور", price:25},
      {name:"رز مندي", price:25}
    ]},
    // الوجبة 3
    {id:"t3", img:"/Dirty55/me00.webp", name:"ربع تيس مندي", basePrice:375, availableIn: ['branch1', 'branch2', 'branch3'], options:[
      {name:"رز شعبي", price:0},
      {name:"رز بشاور", price:13},
      {name:"رز مندي", price:13}
    ]},
    // الوجبة 4
    {id:"t4", img:"/Dirty55/me00.webp", name:"نفر لحم مندي", basePrice:85, availableIn: ['branch1', 'branch2', 'branch3'], options:[
      {name:"رز شعبي", price:0},
  ...
  { 
    ...
    items:[
    // الوجبة 1
    {id:"bev-p", img:"/Dirty55/dr00.webp", name:"ببسي", basePrice:0, availableIn: ['branch1', 'branch2', 'branch3'], options:[
      {name:"صغير", price:3},
      {name:"وسط", price:6},
      {name:"كبير", price:9}
    ]},
  ...
  { 
    ...
    items:[
      ...
      // الوجبة 3
      {id:"eid3", img:"/Dirty55/ed00.webp", name:"مشكل خضار", basePrice:10, availableIn: ['branch1', 'branch2', 'branch3'], options:[{name:"صحن", price:0}]},
      // الوجبة 4
  ...
  { 
    ...
    // الوجبة 8
    {id:"app-mshkl", img:"/Dirty55/ap00.webp", name:"مشكل مقبلات", basePrice:13, availableIn: ['branch1', 'branch2', 'branch3'], options:[{name:"طبق", price:0}]}
  ]},
  { 
    section:"الكنافه", 
    ...
    items:[
      // الوجبة 1
      {id:"kna1", img:"/Dirty55/kn00.webp", name:"كنافه قشطه", basePrice:10, availableIn: ['branch1', 'branch2', 'branch3'], options:[{name:"", price:0}]},
      // الوجبة 2
