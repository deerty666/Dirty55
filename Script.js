// ====================================================================
// 🔧 تحديد المسار الأساسي للمستودع (Dirty55)
// هذا يحل جميع مشاكل المسارات المطلقة على GitHub Pages.
const REPO_BASE_PATH = '/Dirty55';

// دالة لمساعدتنا في بناء رابط مطلق صحيح
...
// ====================================================================
// ✅ المنطق الحاسم: التحقق من الفرع وإيقاف الكود إذا لم يكن موجوداً
// ❌ تم حذف الفحص الزائد والاعتماد فقط على هذا الفحص الشامل
if (!currentBranchId || !BRANCH_CONFIG[currentBranchId]) {
    ...
    // ✅ إيقاف تنفيذ الكود هنا يحل مشكلة الشاشة الفارغة
    return; 
}
// ====================================================================
...
const menuData = [
  ...
  { 
    ...
    // الوجبة 5
    {
      ...
      options: [
        { name: "رز شعبي", price: 0 },
        { name: "رز بشاور", price: 63 }, // 🛑 تركناه 63 كما طلبت (لأنه خطأ بيانات وليس منطق)
        { name: "رز مندي", price: 63 }  // 🛑 تركناه 63 كما طلبت (لأنه خطأ بيانات وليس منطق)
      ]
    },
    // الوجبة 6
    {
...
// ❌ تم حذف تسجيل العامل الخدمي هنا لأننا نقلناه إلى index.html
