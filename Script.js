// ====================================================================
// 🔧 التعديل 3: حماية إضافية في بداية الملف (شبكة أمان ضد الفتح المباشر)
// إعادة توجيه تلقائي لو تم فتح الصفحة بدون فرع
if (!location.search.includes("branch=")) {
    // نستخدم هنا المسار الكامل الذي اتفقنا عليه
    window.location.href = '/Dirty55/branch_selector.html?direct=1'; 
    // نوقف التنفيذ مباشرة
