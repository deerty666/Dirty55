...

{
    ...
    basePrice:1550, 
    isAvailable: true, 
    availableIn: ['branch1', 'branch2', 'branch3'], // ✅ تم تصحيح الخطأ النحوي هنا
    options:[ 
        {name:"رز شعبي", price:0},
...
// الوجبة 5
// ⭐️⭐️ التعديل على نفر حاشي مكموت: basePrice 59، خصم 50 ⭐️⭐️
{
...
basePrice:59, // السعر الأصلي

isBestSeller: true, 
branchDiscounts: { // إضافة خاصية الخصم لجميع الفروع
    'branch1': 50,
    'branch2': 50,
    'branch3': 50
},
...
// الوجبة 6
// ⭐️⭐️ التعديل على نفر برمه لحم: basePrice 80، خصم 68، الأكثر مبيعاً ⭐️⭐️
{
...
basePrice:80, // السعر الأصلي

isBestSeller: true, // إضافة للأكثر مبيعاً
branchDiscounts: { // إضافة خاصية الخصم لجميع الفروع
    'branch1': 68,
    'branch2': 68,
    'branch3': 68
...
// الوجبة 5
// ⭐️⭐️ التعديل على مشكل مشاوي: الأكثر مبيعاً ⭐️⭐️
{
...
// ⭐️⭐️ التعديل على شوربة: الأكثر مبيعاً ⭐️⭐️
...
// الوجبة 1
// ⭐️⭐️ التعديل على جريش: الأكثر مبيعاً ⭐️⭐️
...
// ⭐️⭐️ التعديل الأول: إضافة دالة processMenuData ⭐️⭐️
function processMenuData(data) {
    ...
    data.forEach(section => {
        ...
        section.items.forEach(item => {
            ...
            const itemWithSection = {...item, actualSection: section.section}; 
...
// ⭐️⭐️ نستخدم الدالة الجديدة لمعالجة القائمة مرة واحدة
...
/* ====== Render sections - ✅ تم التعديل لاستخدام processedMenuData ====== */
// ⭐️⭐️ التعديل الثاني: استخدام processedMenuData ⭐️⭐️
...
/* ====== Render menu - تم التعديل لتطبيق الخصم الخاص بالفرع (واستخدام processedMenuData) ====== */
// ⭐️⭐️ التعديل الثالث: استخدام processedMenuData ⭐️⭐️
...
sec.items.map(item => ({...item, actualSection: item.actualSection || sec.section})) : // استخدام actualSection لتحديد القسم الأصلي للوجبة 
...
// نستخدم availableIn الأصلي المخزن في الوجبة (سواء كانت في قسمها الأصلي أو قسم الأكثر مبيعاً)
