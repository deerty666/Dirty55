...
// 🛑 منطق التوجيه القسري: إذا لم يتم تحديد فرع، قم بتحويل المستخدم إلى صفحة اختيار الفروع
if (!currentBranchId || !BRANCH_CONFIG[currentBranchId]) {
    // نفترض أن صفحة اختيار الفروع هي 'branch_selector.html' في مجلد Dirty55
    window.location.href = '/Dirty55/branch_selector.html'; 
    // إيقاف تنفيذ الكود في صفحة القائمة (menu.html) بعد إعادة التوجيه
    throw new Error('Branch not specified, redirecting to selector.'); 
}
