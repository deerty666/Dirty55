// ====================================================================
// 🔧 التعديل 3 المُصحَّح: حماية إضافية في بداية الملف (باستخدام مسار نسبي)
// إعادة توجيه تلقائي لو تم فتح الصفحة بدون فرع
if (!location.search.includes("branch=")) {
    // 🛑 تصحيح: استخدام مسار نسبي branch_selector.html
    window.location.href = 'branch_selector.html?direct=1'; 
    // نوقف التنفيذ مباشرة
