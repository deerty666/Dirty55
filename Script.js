/*// =============================================
// 🎁 منطق الرسالة الترحيبية المؤقتة (5 ثواني)
// =============================================
...
// التحقق للتأكد من وجود العناصر قبل البدء
if (welcomeModal && closeWelcomeBtn) {
    
    // 🌟 إظهار النافذة الترحيبية فوراً
    welcomeModal.style.display = 'flex';

    // ⏳ الإخفاء التلقائي بعد 5000 مللي ثانية (5 ثوانٍ)
    setTimeout(() => {
        // نتحقق من أنها ما زالت معروضة قبل إخفائها تلقائياً
        if (welcomeModal.style.display === 'flex') {
            welcomeModal.style.display = 'none';
        }
    }, 5000);

    // 🖱️ الإغلاق اليدوي عند النقر على الزر
...
const menuData = [
    ...
    { 
        ...
        description: "دجاج شواية طازج متبل ومشوي على الطريقة التقليدية.", //
        items:[
            // الوجبة 1
